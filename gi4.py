...
#ais = LINE()
ais = LINE("Eu3yjZ73Ti4wqhQfqfw5.h2nYRBQJ4QxoQycWDGCQrq.8TIDSOppWmWDPQNxYchA0fdSCCOhrgf7wPZx+1w3ne8=")
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

#ki2 = LINE()
ki2 = LINE("EuVRzPKVZqB3QaAkeSm7.nzmFp1PzV1h4zzhqAJoGHW.BubDZMVCMIdN1PEtJPgjwVDBo9U674kl23dJgUFXiHw=")
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

#ki3 = LINE()
ki3 = LINE("EuzUx0uUvbhjHtJvay8f.c6OFZcq+Ro3UOtEtpidN+W.HSkxZeiWusu5ljeWNErGl0sz4BbFuYHhorISOx0+BG4=")
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

#ki4 = LINE()
ki4 = LINE("EurtJZDAbcvAu5CPXyE2.XP+TMLd+XvudFGFf51wMWG.94EMGEMGJQQSUmWMftjKch10Ho8ENO9qt0gqaaofcrA=")
...
creator = ["u495a9073dade2f6b13b6ccae5cd54f8a"]
Owner = ["u495a9073dade2f6b13b6ccae5cd54f8a"]
admin = ["u495a9073dade2f6b13b6ccae5cd54f8a"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "u495a9073dade2f6b13b6ccae5cd54f8a")
                    gye.sendMessage(to,"█░░╦─╦╔╗╦─╔╗╔╗╔╦╗╔╗░░█\n█░░║║║╠─║─║─║║║║║╠─░░█\n█░░╚╩╝╚╝╚╝╚╝╚╝╩─╩╚╝░░█")
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"➲ Hadir ")
                        ais.sendMessage(msg.to,"➲ Suk")
                        ki2.sendMessage(msg.to,"➲ Hooh")
                        ki3.sendMessage(msg.to,"➲ Iyap")
                        ki4.sendMessage(msg.to,"➲ Ada")
                        gye.sendMessage(msg.to,"➲ Kami lengkap Boss")
